  ...
  return (
    <div className="flex flex-col text-center min-h-screen relative overflow-hidden bg-amber-50 print:[print-color-adjust:exact] ">
      ...
      <div className="z-10 pt-8">
        <h1 className="text-center text-7xl print:text-9xl font-extrabold text-white mb-18 print:[print-color-adjust:exact] ">
          SE BUSCA
        </h1>
        ...
        <div className="mb-3 relative h-3/6">
          ...
          <div className="mx-auto w-7/12 border-[10px] border-amber-300 print:[print-color-adjust:exact] shadow-md">
            <Image
        ...
        <div className=" p-4 print:[print-color-adjust:exact] flex justify-center items-center gap-5 bg-rojillo">
          <p className="text-center text-xl print:text-4xl font-bold text-amber-300 text-balance">
            AYUDANOS COMPARTIENDO EL QR
          </p>
          <div className="w-1/3 h-20 bg-amber-600"></div>
        </div>
